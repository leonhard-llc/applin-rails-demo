json.page Applin::nav_page(title: "Checkbox") {
  Applin::scroll {
    Applin::form(widgets: [
      ...
      Applin::checkbox(text: "Does RPC on change", var_name: "with-rpc", actions: [Applin::rpc(url: "/ok")]),
      Applin::checkbox(text: "Does RPC on change, but it fails", var_name: "with-bad-rpc", actions: [Applin::rpc(url: "/user_error")]),
